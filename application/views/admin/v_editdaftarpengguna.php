                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('c_tambahdaftarpengguna/update'); ?>">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                        id="id_user" aria-describedby="emailHelp"
                                        placeholder="ID User" name="id_user">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                        id="nama asli" aria-describedby="emailHelp"
                                        placeholder="Nama asli..." name="nama_user">
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                        id="username" aria-describedby="emailHelp"
                                        placeholder="username..." name="namalogin_usr">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                        id="exampleInputPassword" placeholder="Password" name="password_usr">
                                    </div>
                                ...
                                <a href="<?= base_url('c_daftarpengguna');?>" class="btn btn-primary btn-user btn-block">
                                    Cancel
                                </a>
                                <hr>
