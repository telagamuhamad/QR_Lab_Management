                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Perencanaan Praktikum</h1>
                                    </div>
                                    <form class="user" method="post" action="<?= base_url('c_tambahrencana/update'); ?>">
                                        <div class="form-group">
                                             <input type="text" class="form-control form-control-user"
                                                id="kodepembelajaran"
                                                placeholder="Kode Pembelajaran" name="kode_belajar">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="judul" 
                                                placeholder="Judul Pembelajaran" name="judul">
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="lokasi" 
                                                placeholder="Lokasi Praktikum" name="lokasi">
                                        </div>
                                        <div class="form-group">
                                            <td> Kebutuhan Aset </td>
                                        </div>                                        

                                        
                       <button type="submit" name="submit" class="btn btn-primary btn-user btn-block">Add</button>
                       <a href="<?= base_url('c_perencanaan'); ?>" class="btn btn-primary btn-user btn-block">
                        Cancel
                    </a>
                                        <hr>
