            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="col-lg-6">
                            <div class="p-5">
                                <a href="<?= base_url('c_tambahrencana');?>" class= "btn btn-primary">Tambah Data</a>
                        ...
                        <td>
                            <?php echo anchor('c_tambahrencana/edit/'.$as->kode_belajar,'Edit'); ?>
                            <?php echo anchor('c_tambahrencana/hapus/'.$as->kode_belajar,'Hapus'); ?>          
                        </td>  
                    </tr>
                </tbody>
            <?php } ?>
